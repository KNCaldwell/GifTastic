...
var topics = ["Christmas", "Thanksgiving", "Kwanzaa", "Fourth of July", "Mothers Day", "Valentines Day"];
...
$("#buttonArea").on("click", ".btn", function(){
  		...
  		queryURL = "https://api.giphy.com/v1/gifs/search?q=" + holidayButton + "&api_key=dc6zaTOxFJmzC&limit=8";
